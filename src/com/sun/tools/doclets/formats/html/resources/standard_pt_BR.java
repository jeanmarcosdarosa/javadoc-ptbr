   ...
   protected final Object[][] getContents()
   {
     return new Object[][] {
                { "doclet.0_Fields_and_Methods", "&quot;{0}&quot; Campos e métodos" },
 				...
 				{ "doclet.Docs_generated_by_Javadoc", "Documentação gerada pelo Javadoc (tradução parcial por Kaléu Caminha)." },
 				{ "doclet.Enclosing_Class", "Enclosing class:" },
 				{ "doclet.Enclosing_Interface", "Enclosing interface:" },
 				{ "doclet.Enum_Hierarchy", "Hierarquia Enum" },
 				...
 				{ "doclet.Href_Enum_Title", "enum em {0}" },
 				...
 				{ "doclet.Style_line_10", "Cores e fontes da barra de navegação" },
